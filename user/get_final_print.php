      ...
      <div class="row invoice-info">
        <div class="col-sm-3 invoice-col text-center pt-1">
          <div class="text-center">
            <img src="../images/logo.jpg" height="auto" width="150px" class="img-fluid " alt="logo image">
          </div>
        </div>
        <!-- /.col -->
        ...
        <div class="col-sm-3  invoice-col text-center pt-1">
          <div class="text-center">
            <img src="../images/logo.jpg" class="img-fluid" height="auto" width="150px" alt="logo image">
          </div>
        </div>
        <!-- /.col -->
      </div>
